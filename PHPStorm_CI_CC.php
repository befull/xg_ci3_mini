<?php defined('BASEPATH') OR exit('No direct script access allowed');
	/**
     * 这个文件的是CI3专用的，作者是在CI2的基础上优化的：
     * https://github.com/nicolas-goudry/CI-PHPStorm-Code-Completion
     * Mark as Plain Text:
     * ● /system/core/Controller.php
     * ● /system/core/Model.php
     * 当在CORE里扩展了核心类的时候，对应的CORE COMPONENTS的CI_修改为My_，by xiaogao。
     * CI2的地址在下面
	 ...
	 * @property My_Input            $input                Pre-processes global input data for security
	 * @property CI_Lang             $lang                 Language Class
	 * @property CI_Loader           $load                 Loads framework components.
	 * @property CI_Log              $log                  Logging Class
	 * @property My_Model            $model                Model Class
     ...
     * @property Excel              $excel               Excel Class
     ***************** YOUR MODELS *****************
	 ...
	 *
	 * @property CI_DB_query_builder $jw2
     * @property auth_group_model    $auth_group_model
     * @property auth_user_model     $auth_user_model
     * @property art_model           $art_model
	 */
	class CI_Controller {
	 ...
	 *
	 * @property CI_DB_query_builder $jw2
	 * @property Datacenter_model         $datacenter_model
     * @property Auth_group_model         $auth_group_model
	 */
	class CI_Model {
		public function __construct() {
