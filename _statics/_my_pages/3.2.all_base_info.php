...
<?php require('0.foot.php')?>
        ...
        <script>
            var dataSet = [
                ...
                [ 11, "123123", "Number1", "1000", "Name1", "2017-11-11", "", "<a href='#' class='btn btn-danger btn-xs'>Delete</a> <a href='#' class='btn btn-primary btn-xs'>Edit</a>" ],

                [ 12, "123123", "Number1", "1000", "Name1",  "2017-11-11", "<span class='label label-default'>Finished</span>","<a href='#' class='btn btn-danger btn-xs'>PDF</a>" ],

                [ 13, "123123", "Number1", "1000", "Name1",  "2017-11-11", "<span class='label label-primary'>Submited</span>","<a href='#' class='btn btn-primary btn-xs'>Check</a>" ],
            ];
