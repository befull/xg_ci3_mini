<?php require('2.0.head.php') ?>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"> My Testing Report</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
...
<?php require('0.foot.php')?>
        ...
        <script>
            var dataSet = [
                ...
                [ 12, "123123", "Number1", "14", "3",  "2017-11-11", "<span class='label label-success'>Testing</span>","<a href='#' class='btn btn-primary btn-xs'>Continue</a>" ],
            ...
            $(document).ready(function() {
                $('#example').DataTable( {
                    ...
                    columns: [
                        ...
                        { title: "Last edit time", "orderable":false},
