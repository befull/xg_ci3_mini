<?php require('2.0.head.php') ?>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"> My Submitted Report </h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
...
<?php require('0.foot.php')?>
        ...
        <script>
            var dataSet = [
                ...
                [ 12, "123123", "Number1", "14", "3",  "2017-11-11", "<span class='label label-primary'>Submitted</span>","<a href='#' class='btn btn-danger btn-xs'>PDF</a>" ],
