...
<head>
    ...
    <title>WeUI</title>
    <link rel="stylesheet" href="<?=STA_URL.'weui/dist/'?>style/weui.css"/>
    <link rel="stylesheet" href="<?=STA_URL.'weui/dist/example/'?>example.css"/>
</head>
<body ontouchstart>
...
<script src="<?=STA_URL.'weui/dist/example/'?>zepto.min.js"></script>
<script type="text/javascript" src="https://res.wx.qq.com/open/js/jweixin-1.0.0.js"></script>
<script src="https://res.wx.qq.com/open/libs/weuijs/1.0.0/weui.min.js"></script>
<script src="<?=STA_URL.'weui/dist/example/'?>example.js"></script>
</body>
</html>